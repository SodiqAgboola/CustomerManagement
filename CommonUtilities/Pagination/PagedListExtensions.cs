...
namespace CommonUtilities.Pagination
{
    ...
    public static class PagedListExtensions
    {
        ...
        public static PagedList<TResult> ConvertPagedListTo<TEntity, TResult>(this IPagedList<TEntity> data) where TResult : new()
        {
            var items = data.Items.SetObjectPropertiesFromList(new List<TResult>());

            var pgList = new PagedList<TResult>();

            pgList.SetItems(items);

            pgList.FirstItemOnPage = data.FirstItemOnPage;
            pgList.HasNextPage = data.HasNextPage;
            pgList.HasPreviousPage = data.HasPreviousPage;
            pgList.IsFirstPage = data.IsFirstPage;
            pgList.IsLastPage = data.IsLastPage;
            pgList.LastItemOnPage = data.LastItemOnPage;
            pgList.PageCount = data.PageCount;
            pgList.PageNumber = data.PageNumber;
            pgList.PageSize = data.PageSize;
            pgList.TotalItemCount = data.TotalItemCount;
